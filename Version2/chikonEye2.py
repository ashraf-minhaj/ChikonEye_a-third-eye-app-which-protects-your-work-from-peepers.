""" ChikonEye Version 2.0 """

#Extending features

"""
1. OpenCV Video feed in GUI          - done.
2. Face Detection                    - done.
3. Floating Buttons                  - done.
4. Button Callback functions 
        0. Default Password          - done.
        i. Training - id             - done,
                     password        - 
        ii. Password to QUIT         - done.
        iii. Settings Menu           - done,
                Change Password      - done.

5. doc.txt file to save password     - done.
6. Record camera feed                - done,
            on screen notification   - done.
7. Training -save face images        - done,
            train password           - done,
            on screen notification   - done,
            on screen sample number  - done.
            input user name          - done,
            save in a file           - done,
            read using ChikonEye     - done,
            show with image box      - done,
            train                    - done.

8. Face Recognition                  - done.
9. about developer                   - done.
10. lock if unauthorized face found  - done.
11. ALT+F4 command disable           -
12. Multiple user?                   - done.
"""
